 ...
 * ```
 */
export declare function request<T = any, V extends Variables = Variables>(options: RequestExtendedOptions<V, T>): Promise<T>;
export declare function request<T = any, V extends Variables = Variables>(url: string, document: RequestDocument | TypedDocumentNode<T, V>, ...variablesAndRequestHeaders: VariablesAndRequestHeadersArgs<V>): Promise<T>;
